        ...
        >
          ...
          <div className="relative flex flex-col justify-center items-start h-full text-white pl-12">
            ...
            <p className="text-lg max-w-lg">
              Order food directly to your lecture hall, or check your past
              orders. Get your meals when and where you need them.
            </p>
          </div>
        </div>
          ...
          <div className="flex items-center bg-green-500 text-white pl-12 pr-10">
            <div className="flex flex-col flex-grow">
              ...
              <p className="text-left mt-2 max-w-xs">
                Browse the menu and create a new order for food delivery right
                to your location.
              </p>
              <button 
